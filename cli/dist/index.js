...
async function emailGate() {
  console.log(LOGO);
  console.log(source_default.yellow("  \u26A1 Coming soon \u2014 ThreatCrush is in private beta.\n"));
  ...
  \u2713 You're on the list!`));
    ...
    console.log(source_default.green(`
  \u{1F381} Refer a friend \u2192 both get lifetime access for $249 (instead of $499)
`));
  } else {
    console.log(source_default.green(`
